...
description: Guide for creating releases, updating changelogs, version bumps, and git tagging for the HomeWizard Instant integration
---

# Release Management

This skill covers the complete release workflow for the HomeWizard Instant Home Assistant integration.
...
Location: `custom_components/homewizard_instant/manifest.json`
...
```bash
# Stage changes
git add CHANGELOG.md custom_components/homewizard_instant/manifest.json
...
| `custom_components/homewizard_instant/manifest.json` | Update `version` field |
